...
<p><h2><strong>一、软件授权协议</strong></h2></p>
     <p>&nbsp;&nbsp;&nbsp;&nbsp;1、版权所有 (c) 2009-<?php echo date('Y');?>，爱家房产保留所有权利。 <br />
        &nbsp;&nbsp;&nbsp;&nbsp;2、感谢您选择 AIJIACMS 产品。希望我们的努力能为您提供一个小巧易用，高效快速的网站解决方案。 <br />
        &nbsp;&nbsp;&nbsp;&nbsp;3、AIJIACMS是"爱家网站管理系统"的英文简称。 <br />
       &nbsp;&nbsp;&nbsp;&nbsp;4、爱家房产(AIJIACMS)网站管理系统的官方网站为 http://www.aijiacms.com，是 AIJIACMS 产品的开发商，依法独立拥有 AIJIACMS 产品著作权。<br />
        &nbsp;&nbsp;&nbsp;&nbsp;5、爱家房产(AIJIACMS) 著作权受到法律和国际公约保护。使用者：无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用 爱家房产(AIJIACMS) 软件。 </p>
      <p><h2><strong>二、协议许可的权利 </strong></h2></p>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。 <br />
        &nbsp;&nbsp;&nbsp;&nbsp;2、您可以在协议规定的约束和限制范围内修改 爱家房产(AIJIACMS) 源代码(如果被提供的话)或界面风格以适应您的网站要求。 <br />
      ...
      <p>&nbsp;&nbsp;&nbsp;&nbsp;1、未获商业授权之前，不得将去除本软件的头部版权信息。购买商业授权请登陆http://www.aijiacms.com参考相关说明。 <br />
        &nbsp;&nbsp;&nbsp;&nbsp;2、不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。 <br />
        &nbsp;&nbsp;&nbsp;&nbsp;3、无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用 AIJIACMS 的整体或任何部分，未经书面许可，网站页面页脚处，头部的 爱家房产(AIJIACMS) 名称和 http://www.aijiacms.com 的链接都必须保留，而不能清除或修改，除非您获得AIJIACMS开发者授权许可。 <br />
        &nbsp;&nbsp;&nbsp;&nbsp;4、禁止在 爱家房产(AIJIACMS) 的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。 <br />
      ...
      <p>&nbsp;&nbsp;&nbsp;&nbsp;1、本软件及所附带的文件是作为不提供任何明确的或隐含的赔偿或担保的形式提供的。 <br />
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;2、爱家房产(AIJIACMS)开发者不对使用本软件构建的网站中的文章或信息承担责任。 <br />
        &nbsp;&nbsp;&nbsp;&nbsp;3、有关 爱家房产(AIJIACMS) 最终用户授权协议、商业授权与技术服务的详细内容，均由 爱家房产(AIJIACMS) 官方网站独家提供。AIJIACMS开发者拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。 </p>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;4、电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始安装 AIJIACMS，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
