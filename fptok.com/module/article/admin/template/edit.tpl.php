...
设置内容第 <input name="post[thumb_no]" type="text" size="2" value="<?php echo $MOD['first_pic']?>" /> 张图片为标题图
</td>
</tr>
...
<td><input name="post[tag]" type="text" size="60" value="<?php echo $tag;?>"/>&nbsp;<input type="checkbox" name="post[uptag]" value="<?php echo $MOD['save_tag']?>" <?php if($MOD['save_tag']) echo 'checked';?>>自动生成&nbsp;<?php tips('多个关键词请用空格隔开');?></td>
</tr>
<tr>
