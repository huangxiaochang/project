...
//微信jssdk开始
if($AJ_MOB[browser]=='weixin' && $EXT['gl_wxjssdk']) {
	require AJ_ROOT.'/api/weixin/glinit.inc.php';
}
//微信jssdk结束
...
if($mid) {
	...
	if($_credit < 0 && $MST['credit_less'] && $action == 'add') dheader('/member/credit.php?action=less');
	if($submit) {
