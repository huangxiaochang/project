...
if($toolbarset == 'Aijiacms') {
	...
	$editor .= "['source','|','bold','italic','underline','forecolor','fontsize','|','justifyleft','justifyright','justifycenter','|','drafts','removeformat','|','link','unlink','simpleupload','attachment','insertframe','fullscreen']";
} elseif($toolbarset == 'Basic') {
	$editor .= "['source','|', 'bold','forecolor','|','justifyleft','justifyright','justifycenter','|','drafts','removeformat','|','link','unlink','simpleupload','insertframe','fullscreen']";
} elseif($toolbarset == 'Message') {
	$editor .= "['source','|','bold','italic','underline','forecolor','fontsize','|','justifyleft', 'justifycenter', 'justifyright','|','removeformat','|','link', 'unlink','emotion','simpleupload','attachment','insertframe','fullscreen']";
} else {
	$editor .= "['source','|','undo', 'redo', '|','preview','print','formatmatch','pasteplain','drafts','removeformat','|','inserttable','insertrow', 'insertcol', '|','justifyleft','justifyright','justifycenter','justifyjustify','|','link','unlink','anchor'],['fontfamily','fontsize','|','forecolor','backcolor','bold','italic','underline','strikethrough','|','emotion', 'map','|','simpleupload','insertimage','insertvideo','attachment','insertframe','fullscreen']";
}
