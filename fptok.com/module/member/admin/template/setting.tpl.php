...
<td class="tl">注册邮件</td>
<td>
<input type="radio" name="setting[email_register]" value="1" <?php if($email_register) echo 'checked';?>/> 开启&nbsp;&nbsp;
<input type="radio" name="setting[email_register]" value="0" <?php if(!$email_register) echo 'checked';?>/> 关闭
</td>
</tr>
