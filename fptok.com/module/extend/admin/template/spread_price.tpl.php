...
<td><input name="post[<?php echo $v['itemid'];?>][newhouse_price]" type="text" size="10" value="<?php echo $v['newhouse_price'];?>"/></td>
<td><input name="post[<?php echo $v['itemid'];?>][sell_price]" type="text" size="10" value="<?php echo $v['sell_price'];?>"/></td>
<td><input name="post[<?php echo $v['itemid'];?>][rent_price]" type="text" size="10" value="<?php echo $v['rent_price'];?>"/></td>
...
<td><input name="post[0][newhouse_price]" type="text" size="10" value=""/></td>
<td><input name="post[0][sell_price]" type="text" size="10" value=""/></td>
<td><input name="post[0][rent_price]" type="text" size="10" value=""/></td>
