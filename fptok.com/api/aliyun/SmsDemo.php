...
require_once AJ_ROOT . "/api/aliyun/api_sdk/vendor/autoload.php";
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIU01msm6fnr9p"; // AccessKeyId

        $accessKeySecret = "kF4o3rMN8KXIoPRzTHDdtY1ZmHssXr"; // AccessKeySecret
    ...
    public static function sendSms($mobile, $data) {
        ...
        $request->setSignName("房平台");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_136161013");
 ...
 function alisms($mobile,$data){
   ...
   $secret = 'kF4o3rMN8KXIoPRzTHDdtY1ZmHssXr'; //App Secret
	//$sms = new SmsDemo();
	$response = SmsDemo::sendSms($mobile, $data);
   //$response = $sms->sendSms($mobile, $data);
   if($response){
        $code = '成功';
        $status = 1;
    }else{
