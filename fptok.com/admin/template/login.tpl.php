...
<form method="post" action="?"  onsubmit="return Dcheck();">
	...
	<table cellspacing="0" align="center">
		...
		<tr>
            ...
            <input type="submit" name="submit" value="登 录" class="button" tabindex="4" id="submit"/>&nbsp;&nbsp;<input type="button" value="退 出" class="button" onclick="top.Go('<?php echo AJ_PATH;?>');"/>
			
			</td>
		</tr>
		<tr><td colspan="2" class="copyright">Powered by <strong>房平台</strong> &copy; 2018-<?php echo date('Y');?></td></tr>
