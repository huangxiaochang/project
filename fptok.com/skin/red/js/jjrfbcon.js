									...
									delay = setTimeout(function() {
										$.ajax({
											...
											if (data.length > 0) {
												l = data.length;
												for (; i < l; i++) {
													html += '<li data-val="'+data[i].hid+'"><b>' + data[i].name + '</b><span> ' + data[i].address + '</span><em style="display:none;"> ' + data[i].map + '</em><strong style="display:none;"> ' + data[i].areaid + '</strong></li>';
												}
											}
