...
<tr>
<td class="tl">默认第一张图片为封面</td>
<td>
<input type="radio" name="setting[first_pic]" value="1"  <?php if($first_pic) echo 'checked';?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[first_pic]" value="0"  <?php if(!$first_pic) echo 'checked';?>/> 关闭
</td>
</tr>
<tr>
...
<tr>
<td class="tl">自动获取标签</td>
<td>
<input type="radio" name="setting[save_tag]" value="1"  <?php if($save_tag) echo 'checked';?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[save_tag]" value="0"  <?php if(!$save_tag) echo 'checked';?>/> 关闭
</td>
</tr>
