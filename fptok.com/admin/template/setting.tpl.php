...
<tr>
<td class="tl">bShare分享UUID</td>

<td><input name="setting[uuid]" type="text" value="<?php echo $uuid;?>" size="40"/><?php tips('主要是手机版分享调用');?> <a href="http://www.bshare.cn/" target="_blank">我要申请</a></td>
...
<tr>
<td class="tl">极验验证是否开启</td>
<td>
<input type="radio" name="setting[geetest_on]" value="1"  <?php if($geetest_on){ ?>checked <?php } ?> onclick="Ds('dgeetest_on');"/> 是&nbsp;&nbsp;<a href="http://www.geetest.com/" target="_blank" class="t">我要申请</a>
<input type="radio" name="setting[geetest_on]" value="0"  <?php if(!$geetest_on){ ?>checked <?php } ?> onclick="Dh('dgeetest_on');"/> 否
</td>
</tr>
<tbody id="dgeetest_on" style="display:<?php if(!$geetest_on) echo 'none';?>">
<tr>
<td class="tl">极验captcha_id</td>
<td><input name="setting[captchaid]" type="text" id="captchaid" value="<?php echo $captchaid;?>" size="50"/><?php tips('从极验后台注册获取的公钥(id)和私钥(key)');?>&nbsp;&nbsp;&nbsp;&nbsp;</td> 
</tr>
<tr>
<td class="tl">极验private_key</td>
<td><input name="setting[privatekey]" type="text" id="privatekey" value="<?php echo $privatekey;?>" size="50"/><?php tips('从极验后台注册获取的公钥(id)和私钥(key)');?></td>
</tr>
</tbody>
...
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl">手机版定位</td>
<td>
<input type="radio" name="setting[local_bdmap]" value="1"  <?php if($local_bdmap){ ?>checked <?php } ?> onclick="Ds('local_bdmap');"/> 百度地图定位&nbsp;&nbsp;
<input type="radio" name="setting[local_bdmap]" value="0"  <?php if(!$local_bdmap){ ?>checked <?php } ?> onclick="Dh('local_bdmap');"/> 百度ip API定位<?php tips('选择手机版网站的定位方式');?>
</td>
<tr>
<td class="tl">百度地图ak key</td>
<td><input name="setting[cloud_bdmap_ak]" type="text" id="cloud_bdmap_ak" value="<?php echo $cloud_bdmap_ak;?>" size="50"/><?php tips('百度地图api申请的ak key需创建应用，用于百度地图坐标转换，地理位置识别,地图导航，附近商家等等');?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://lbsyun.baidu.com/" target="_blank" class="t">[百度地图ak key]</a></td> 
</tr>
<tr>
<td class="tl">百度APIStore key</td>
<td><input name="setting[cloud_bdapi_key]" type="text" id="cloud_bdapi_key" value="<?php echo $cloud_bdapi_key;?>" size="50"/><?php tips('百度APIStore调用服务所需要的API密钥，一个用户只有一个apikey，可以调用平台所有即用服务');?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://apistore.baidu.com/" target="_blank" class="t">[百度APIStore key]</a></td>
</tr>
</table>
</div>
...
<tr>
<td class="tl">短信单价</td>
<td><input name="setting[sms_fee]" type="text" value="<?php echo $sms_fee;?>" size="5"/> <?php echo $AJ['money_unit'];?>/条 <?php tips('此项针对会员收费');?>余额<?php echo NewSms();?></td> 
</tr>
<tr>
<td class="tl">每日上限</td>
