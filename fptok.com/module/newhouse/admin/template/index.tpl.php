...
<td><a href="javascript:Dwidget('?moduleid=6&file=xiangce&houseid=<?php echo $v['itemid'];?>&title=<?php echo $v['title'];?>', '[<?php echo $v['alt'];?>] 相册列表',800, 400)">[<?php echo get_xiangcenum($v['itemid'],'');?>]</a></td>
<td><a href="javascript:Dwidget('?moduleid=6&file=huxing&houseid=<?php echo $v['itemid'];?>&title=<?php echo $v['title'];?>', '[<?php echo $v['alt'];?>] 户型列表',800, 400)">[<?php echo get_huxingnum($v['itemid'],'');?>]</a></td>
